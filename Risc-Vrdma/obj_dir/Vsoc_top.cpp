...
Vsoc_top::Vsoc_top(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , desc_valid{vlSymsp->TOP.desc_valid}
    , desc_ready{vlSymsp->TOP.desc_ready}
    , rdma_done{vlSymsp->TOP.rdma_done}
    , rdma_error{vlSymsp->TOP.rdma_error}
    , mem_test_pass{vlSymsp->TOP.mem_test_pass}
    , desc_addr{vlSymsp->TOP.desc_addr}
    , rootp{&(vlSymsp->TOP)}
{
